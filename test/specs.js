...
// check if the the isFive() function works as intended to
// determine if an argument is a numerical 5
describe('isFive(num)', () => {
...
// check if the the isOdd() function works as intended to
...
// check if the the myRange() function works as intended to
// generate an array with numbers from the first (min) to the second (max)
// at a step increase. The default step should be 1,
